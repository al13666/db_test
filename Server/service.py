...
@app.route('/achievements', methods = ['GET', 'POST', 'DELETE'])
def achievements():
    if request.method=='GET':
        ...
        request_to_db = """
            INSERT INTO achievements (name, points, description, description_rus, name_rus) 
            VALUES (%s, %s, %s, %s, %s);
        """
...
@app.route('/relation', methods = ['GET', 'POST', 'DELETE'])
def relation():
...
@app.route('/show_user_achievements/<string:name_user>')
...
@app.route('/statistic/<string:function>')
